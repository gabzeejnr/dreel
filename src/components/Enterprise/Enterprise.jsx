    ...
    return (
        <section id="home-enterprise" className="min-h-screen">
            <div className="background-overlay flex flex-col text-white gap-10 items-center pt-10 pb-10">
                <div className="mb-10 text-center flex flex-col gap-5 max-w-150">
                ...
                <div className="cards grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 px-10 md:px-10 gap-5 lg:px-15">
                    {cardItems.map(card => (
